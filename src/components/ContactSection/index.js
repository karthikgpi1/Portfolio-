  ...
  return (
    <div id="contact">
      ...
      <div className="mail-contact mb-5">
        ...
        <a
          href="mailto:karthikgopi024@gmail.com"
          rel="noreferrer"
      ...
      <div className="mail-contact mb-5">
        <div className="contacts p-4 text-center">
          ...
          <span>karthikgopi024@gmail.com</span>
        </div>
        <div className="contacts p-4 text-center">
          <i className="fad fa-mobile-alt"></i> <span>+91 9585337819</span>
        </div>
      ...
      <div className="footer mt-3">
        <span className="float-left">
          <a
            href="https://github.com/karthikgpi1"
            target="_blank"
            rel="noreferrer"
          ...
          &emsp;
          <a
            href="https://www.linkedin.com/in/karthik-m-68b16816b/"
            target="_blank"
            rel="noreferrer"
            className="btn btn-sm btn-success btn-circle"
          >
        ...
        <span> All Rights Reserved by Karthik M </span>
      </div>
    </div>
  );
}
